...
import ETESpeechRecognition.config as config
...
class E2E(nn.Module):
	...
	def __init__(self, idim, odim, args, ignore_id=-1, char_list=None, get_features=False):
		...
		if config.use_cuda:
			...
			self.fbank = [fbank.to(torch.device('cpu:0'))]
